...
* Improved gRPC mock streaming, manual scenario sending, and runtime controls.
* Improved Web Access HTTPS, HTTP/2, certificate trust, and mock settings.
* Improved live response viewing with stable scrolling and smoother latest message updates.
* Improved Proto import, collection, request, and workspace interactions.

### Fixes

* Fixed live response blinking, unexpected scrolling, and WebSocket view switching.
* Fixed Proto drag-and-drop state and collection drop behavior.
* Fixed HTTPS certificate handling and Web Access runtime issues.
* Fixed TypeScript, lint, and runtime compatibility issues.
