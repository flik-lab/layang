...
Usage:
  ...
  layang schema:archive <workspace> --schema <name-or-id>
  layang schema:restore <workspace> --schema <name-or-id>
  layang schema:revision-archive <workspace> --schema <name-or-id> --revision <label-or-id>
  layang schema:revision-restore <workspace> --schema <name-or-id> --revision <label-or-id>
  layang schema:revision-delete <workspace> --schema <name-or-id> --revision <label-or-id> [--replacement <label-or-id>] --yes
  ...
  layang git:change-set-create <workspace> --name "Feature: Watch Track" [--id <id>] [--path <file>]
  layang git:change-set-assign <workspace> --id <change-set-id> --path <file>
  layang git:change-set-delete <workspace> --id <change-set-id>
